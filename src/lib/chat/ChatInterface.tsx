...
function Message({ message, currentUserId, users }: MessageProps) {
  ...
  const bubbleStyle: React.CSSProperties = {
    ...
    background: isOwn ? (message.pending ? "#374151" : message.failed ? "#7f1d1d" : "#2563eb") : "#2a2a4a",
    color: "#fff",
    position: "relative",
    opacity: message.pending ? 0.7 : 1,
    boxShadow: message.pending ? "0 0 0 1px #6b7280" : message.failed ? "0 0 0 1px #ef4444" : "none",
    ...
    <div style={wrapperStyle}>
      {!isOwn && (
        <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "2px" }}>
          <div style={avatarStyle}>{getInitials(message.senderName)}</div>
      ...
      <div style={styles.header}>
        ...
        <div style={styles.presence}>
          {users.slice(0, 5).map((user) => {
            const userColor = getColorForName(user.name);
            const avatarStyle: React.CSSProperties = {
              width: "32px",
              height: "32px",
              borderRadius: "50%",
            ...
            const statusDotStyle: React.CSSProperties = {
              ...
              height: "8px",
              borderRadius: "50%",
              background: user.status === "online" ? "#22c55e" : "#6b7280",
              marginLeft: "-8px",
