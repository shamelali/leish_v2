      ...
      <div className="flex flex-1 flex-col p-4">
        <div className="flex items-start justify-between gap-2">
          ...
          <span className="flex shrink-0 items-center gap-1 text-sm font-medium text-stone-800 dark:text-stone-200">
            ...
            <span className="font-normal text-stone-400 dark:text-stone-500">({artist.reviewCount})</span>
          </span>
        </div>
        <p className="mt-1 line-clamp-2 text-sm text-stone-500 dark:text-stone-400">{artist.tagline}</p>
