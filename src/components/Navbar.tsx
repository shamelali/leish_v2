...
export function Navbar() {
  ...
  return (
    <header
      ...
      style={{ background: "linear-gradient(90deg, var(--leish-header-from), var(--leish-header-to))" }}
    >
        ...
        >
          <div className="flex flex-col gap-1">
            ...
            <div className="mt-3 flex gap-3 border-t border-white/20 pt-4">
              {user ? (
                <>
                  <Link href="/dashboard" onClick={() => setOpen(false)} className={cn(ghostBtn, "flex-1")}>
                    Dashboard
                  </Link>
                ...
                <>
                  <Link href="/login" onClick={() => setOpen(false)} className={cn(ghostBtn, "flex-1")}>
                    Log in
                  </Link>
                  <Link href="/register" onClick={() => setOpen(false)} className={cn(solidBtn, "flex-1")}>
                    Sign up
                  </Link>
                </>
              )}
