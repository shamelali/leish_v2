  ...
  return (
    <LegalDoc title="Terms of Use" updated="23 Aug 2026">
      <p>
        ...
        <strong>[NUMBER]</strong>) (&ldquo;Leish!&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;). By
        creating an account or booking through the Platform you agree to these Terms and our{" "}
      ...
      <ul>
        <li>
          You must be at least [18] years old to book. Minors may receive services only with a
          parent or guardian&rsquo;s booking and supervision.
        </li>
        <li>
          Provide accurate details and keep your password confidential; you are responsible for
      ...
      <ol className="ml-5 list-decimal space-y-1">
        <li>
          <strong>Request:</strong> choose an artist/studio, service, date, time and event type,
          then send a booking request. The slot is not reserved yet.
        </li>
        <li>
          <strong>Acceptance &amp; quotation:</strong> the professional reviews your request and
          accepts, declines, or proposes a Quotation. Quotations are valid for the period shown
          (typically 24 hours).
        </li>
        <li>
          <strong>Deposit:</strong> paying the deposit shown at checkout confirms the booking and
          locks the slot exclusively for you.
        </li>
        <li>
          <strong>Balance:</strong> unless stated otherwise on your quotation, the balance is due no
          later than <strong>3 days before your event</strong>. We will email you reminders.
        </li>
      </ol>
      <p>
        A contract for the beauty service itself is formed{" "}
        <strong>between you and the professional</strong>. Leish! is a marketplace: we provide
        discovery, booking, messaging, payment collection and dispute-assistance tooling, but we do
        not perform beauty services and do not guarantee results.
      </p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              Balance (if paid) refunded in full; deposit [retained / refunded less handling fee].
            </td>
          </tr>
          <tr>
      ...
      <ul>
        <li>
          Raise service disputes within 48 hours of the appointment via [SUPPORT EMAIL] or dashboard
          messaging so evidence stays fresh.
        </li>
        <li>
          We mediate using on-platform records (messages, timestamps, payment status) as primary
          evidence and may issue refunds where fair. We do not guarantee any particular outcome.
        </li>
        <li>
          Nothing in these Terms limits your rights under Malaysian consumer law, including the
      ...
      <p>
        ...
        off-platform payments for Platform bookings. Reviews are for genuine completed bookings; we
        remove defamatory or fraudulent reviews and otherwise publish them unedited.
      </p>
      ...
      <p>
        ...
        use of the Platform is limited to the total fees you paid through the Platform in the 6
        months before the claim. We are not liable for indirect or consequential loss, or for
