...
import { GoogleLanguageModelOptions, GoogleSpeechModelOptions } from '@ai-sdk/google';
...
declare const googleVertexTranscriptionProviderOptionsSchema: z.ZodObject<{
    languageCodes: z.ZodOptional<z.ZodArray<z.ZodString>>;
    enableAutomaticPunctuation: z.ZodOptional<z.ZodBoolean>;
    enableWordTimeOffsets: z.ZodOptional<z.ZodBoolean>;
    region: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
type GoogleVertexTranscriptionModelOptions = z.infer<typeof googleVertexTranscriptionProviderOptionsSchema>;

type GoogleVertexImageModelOptions = Omit<GoogleLanguageModelOptions, 'responseModalities'>;
...
type GoogleVertexSpeechModelOptions = GoogleSpeechModelOptions;
...
interface GoogleVertexProvider extends ProviderV4 {
     ...
     */
    transcription(modelId: GoogleVertexTranscriptionModelId): TranscriptionModelV4;
    /**
     * Creates a model for transcription (speech-to-text).
     */
    transcriptionModel(modelId: GoogleVertexTranscriptionModelId): TranscriptionModelV4;
}
...
declare function createGoogleVertex(options?: GoogleVertexProviderSettings): GoogleVertexProvider;
/**
