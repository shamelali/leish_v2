...
var retryWithExponentialBackoffRespectingRetryHeaders = ({
  ...
  backoffFactor,
  abortSignal,
  shouldRetry: (error) => error instanceof Error && (import_provider28.APICallError.isInstance(error) && error.isRetryable === true || import_gateway3.GatewayError.isInstance(error) && error.isRetryable === true),
