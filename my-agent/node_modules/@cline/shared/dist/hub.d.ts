...
export type HubCompatibilityResult = {
    ...
    compatible: false;
    reason: "missing_protocol" | "unsupported_protocol";
};
export declare function isHubProtocolCompatible(hub: HubProtocolMetadata, clientProtocolVersion?: HubProtocolVersion): HubCompatibilityResult;
...
export declare const ONE_TIME_SCHEDULE_CRON_PATTERN = "0";
export declare const ONE_TIME_SCHEDULE_RUN_AT_METADATA_KEY = "__hubScheduleRunAt";
export declare const HUB_SCHEDULE_MODES: readonly ["act", "plan", "yolo"];
export type HubScheduleMode = (typeof HUB_SCHEDULE_MODES)[number];
export declare function isHubScheduleMode(value: unknown): value is HubScheduleMode;
export declare function readHubScheduleMode(payload: Record<string, unknown> | undefined, defaultWhenAbsent: HubScheduleMode): HubScheduleMode;
export declare function readHubScheduleMode(payload: Record<string, unknown> | undefined): HubScheduleMode | undefined;
